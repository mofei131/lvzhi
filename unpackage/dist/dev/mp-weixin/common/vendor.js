...
Api = /*#__PURE__*/function (_Base) {_inherits(Api, _Base);var _super = _createSuper(Api);function Api() {_classCallCheck(this, Api);return _super.apply(this, arguments);}_createClass(Api, [{ key: "login", value: function login(
    param, callback) {
      var param = {
        url: urlList.login,
        type: "get",
